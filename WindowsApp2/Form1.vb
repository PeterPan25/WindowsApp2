Public Class Form1
    ...
    Private Sub LL_Aaliyah_Stammdaten_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LL_Aaliyah_Stammdaten.LinkClicked
        P_Aaliyah_Stammdaten.Show()
        P_Aaliyah_Kontakte.Visible = False
        P_Aaliyah_Stammdaten.Visible = True
    End Sub

    Private Sub LL_Aaliyah_Kontakte_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LL_Aaliyah_Kontakte.LinkClicked
    ...
    Private Sub LinkLabel205_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LL_Aaliyah_Hilfen.LinkClicked
